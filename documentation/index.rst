...
The first thing we need to do to get going using this code is to :doc:`build </building>` the aether library, then once we have built the library we can run it.  Before you start to develop the code make sure you read the section on testing.  Lastly, before you ask to get your code merged make sure you have looked at the modules and fortran styles sections to ensure that you have followed the conventions for this codebase.
