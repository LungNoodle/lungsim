...
!!!#############################################################################
  ...
  subroutine define_elem_geometry_2d(ELEMFILE,sf_option)
    ...
    write(*,*) 'num_elem 2d=',num_elems_2d
    ne = 0
...
!###################################################################################
! 
  subroutine triangles_from_surface(num_triangles,num_vertices,triangle,vertex_xyz)
     ...
     integer :: i,j,ne,num_triangles,num_tri_vert,num_vertices
     ...
     write(*,'('' Made'',I8,'' vertices to cover surface elements'')') &
           num_vertices
