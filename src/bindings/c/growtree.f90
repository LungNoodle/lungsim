...
!*growtree:* the main growing subroutine. Generates a volume-filling tree into a closed surface.
  subroutine grow_tree_c(parent_ne, angle_max, angle_min, branch_fraction, length_limit,&
...
!   integer,intent(in) :: surface_elems(:)
    ...
    call so_grow_tree(parent_ne, angle_max, angle_min, branch_fraction, length_limit,&
shortest_length, rotation_limit, to_export, filename_f)
#else
    call grow_tree(parent_ne, angle_max, angle_min, branch_fraction, length_limit,&
shortest_length, rotation_limit, to_export, filename_f)
#endif
