...
subroutine evaluate_wave_transmission_c(grav_dirn,grav_factor,n_time,heartrate,&
  a0,no_freq,a,b,n_adparams,admittance_param,n_model,model_definition) bind(C, name="evaluate_wave_transmission_c")
...
call so_evaluate_wave_transmission(grav_dirn,grav_factor,n_time,heartrate,a0,no_freq,a,&
  b,n_adparams,admittance_param,n_model,model_definition)
#else
