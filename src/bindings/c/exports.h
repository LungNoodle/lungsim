...
SHO_PUBLIC void export_elem_geometry_2d(const char *EXELEMFILE, const char *name);
...
SHO_PUBLIC void export_node_geometry_2d(const char *EXNODEFILE, const char *name);
