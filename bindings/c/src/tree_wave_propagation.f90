...
subroutine evaluate_wave_propagation_c(no_freq,a0,a,b) bind(C, name="evaluate_wave_propagation_c")
...
call so_evaluate_wave_propagation(no_freq,a0,a,b)
#else
call evaluate_wave_propagation(no_freq,a0,a,b)
#endif
